    ...
    private static void handleLogin() {
        ...
        if (authenticatedUser != null) {
            ...
            if (authenticatedUser instanceof Admin) {
                ...
                menu.showMenu((Admin) authenticatedUser, Shipment.getShipmentList(), users);
            } 
            else if (authenticatedUser instanceof Sender) {
                SenderMenu menu = new SenderMenu();
                menu.showMenu((Sender) authenticatedUser, Shipment.getShipmentList()); 
            } 
            else if (authenticatedUser instanceof Courier) {
                CourierMenu menu = new CourierMenu();
                menu.showMenu((Courier) authenticatedUser, Shipment.getShipmentList());
            }
        } else {
